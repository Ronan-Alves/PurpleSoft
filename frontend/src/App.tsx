...
import { isLoggedIn, UserFilterProvider } from "./app/shared";
import FactoryDashboard from "./pages/FactoryDashboard";
import LoginPage from "./pages/LoginPage";
import Dashboard from "./pages/OperationDashboard";
import AreaPage, { AdmissionManualsPage, PersonnelRequestPage, WorkstationPage } from "./pages/AreaPage";
  ...
  return (
    <BrowserRouter>
      <UserFilterProvider><Routes>
        ...
        <Route path="/area/pessoal/solicitacoes/nova" element={<PrivateRoute><PersonnelRequestPage /></PrivateRoute>} />
